...
sourcesIndex["bytecode"] = {"name":"","files":["annotations.rs","borrow_analysis.rs","clean_and_optimize.rs","compositional_analysis.rs","dataflow_analysis.rs","eliminate_imm_refs.rs","eliminate_mut_refs.rs","function_data_builder.rs","function_target.rs","function_target_pipeline.rs","graph.rs","lib.rs","livevar_analysis.rs","memory_instrumentation.rs","packed_types_analysis.rs","reaching_def_analysis.rs","spec_instrumentation.rs","stackless_bytecode.rs","stackless_bytecode_generator.rs","stackless_control_flow_graph.rs","usage_analysis.rs"]};
...
sourcesIndex["diem_dev"] = {"name":"","files":["crypto.rs","error.rs","interface.rs","lib.rs","transaction.rs"]};
...
sourcesIndex["diem_fuzzer"] = {"name":"","dirs":[{"name":"fuzz_targets","files":["consensus.rs","executor.rs","json_rpc_service.rs","mempool.rs","move_vm.rs","network.rs","proof.rs","safety_rules.rs","secure_json_rpc_client.rs","secure_storage_vault.rs","state_sync.rs","storage.rs","transaction.rs","vm.rs"]}],"files":["commands.rs","fuzz_targets.rs","lib.rs"]};
...
sourcesIndex["diem_infallible"] = {"name":"","files":["lib.rs","mutex.rs","nonzero.rs","rwlock.rs","time.rs"]};
sourcesIndex["diem_jellyfish_merkle"] = {"name":"","dirs":[{"name":"iterator","files":["mod.rs"]},{"name":"nibble_path","files":["mod.rs"]},{"name":"node_type","files":["mod.rs"]},{"name":"restore","files":["mod.rs"]},{"name":"tree_cache","files":["mod.rs"]}],"files":["lib.rs","mock_tree_store.rs","test_helper.rs"]};
...
sourcesIndex["diem_json_rpc_client"] = {"name":"","dirs":[{"name":"async_client","files":["client.rs","defaults.rs","error.rs","http_client.rs","mod.rs","retry.rs","state.rs"]}],"files":["blocking.rs","client.rs","lib.rs","response.rs"]};
...
sourcesIndex["diem_network_address"] = {"name":"","files":["encrypted.rs","lib.rs"]};
...
sourcesIndex["diem_secure_json_rpc"] = {"name":"","files":["lib.rs"]};
...
sourcesIndex["diem_vm"] = {"name":"","files":["access_path_cache.rs","counters.rs","data_cache.rs","diem_transaction_executor.rs","diem_transaction_validator.rs","diem_vm.rs","errors.rs","lib.rs","logging.rs","system_module_names.rs","transaction_metadata.rs"]};
...
sourcesIndex["language_e2e_tests"] = {"name":"","dirs":[{"name":"account_universe","files":["bad_transaction.rs","create_account.rs","peer_to_peer.rs","rotate_key.rs","universe.rs"]},{"name":"execution_strategies","files":["basic_strategy.rs","guided_strategy.rs","mod.rs","multi_strategy.rs","random_strategy.rs","types.rs"]}],"files":["account.rs","account_universe.rs","common_transactions.rs","compile.rs","currencies.rs","data_store.rs","executor.rs","gas_costs.rs","golden_outputs.rs","keygen.rs","lib.rs","proptest_types.rs"]};
...
sourcesIndex["move_prover"] = {"name":"","files":["boogie_helpers.rs","boogie_wrapper.rs","bytecode_translator.rs","cli.rs","lib.rs","prelude_template_helpers.rs","prover_task_runner.rs","spec_translator.rs"]};
...
sourcesIndex["move_vm_test_utils"] = {"name":"","files":["effects.rs","lib.rs","misc.rs","storage.rs"]};
...
sourcesIndex["state_synchronizer"] = {"name":"","dirs":[{"name":"tests","files":["fuzzing.rs","mod.rs"]}],"files":["chunk_request.rs","chunk_response.rs","coordinator.rs","counters.rs","executor_proxy.rs","lib.rs","logging.rs","network.rs","request_manager.rs","state_synchronizer.rs"]};
sourcesIndex["stdlib"] = {"name":"","files":["lib.rs","utils.rs"]};
...
sourcesIndex["transaction_builder_generated"] = {"name":"","files":["lib.rs","misc.rs","stdlib.rs"]};
